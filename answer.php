...
<head>
  <meta charset="utf-8" />
  <meta name="description" content="Student discount for the museum, PHP" />
  ...
  <title>"Student discount for the museum, PHP"</title>
</head>
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header">
      <div class="mdl-layout__header-row">
        <span class="mdl-layout-title">"Student discount for the museum, PHP"</span>
      </div>
    </header>
    <main class="mdl-layout__content">
      <div class="right-image">
        <img src="./images/ticket.jpeg" alt="Image of tickets." />
      </div>
